...
<c:url var="formActionUrl" value="/userMgt/${formAction}.htm"/>
<form:form modelAttribute="userCmd" method="POST" action="${formActionUrl}" id="form1">
    <div>
    ...
    <div class="buttonDiv">
        <input type="submit" value="<fmt:message key="pass.send"/>"/>
    </div>
</form:form>
